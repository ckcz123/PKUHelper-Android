	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mViewPager.setAdapter(new FragmentPagerAdapter(getFragmentManager()) {
			...
			public Fragment getItem(int arg0) {
				if (arg0==1) return Fragment.instantiate(bbsActivity, "com.pkuhelper.bbs.AllBoardsFragment");
				if (arg0==2) return Fragment.instantiate(bbsActivity, "com.pkuhelper.bbs.SearchFragment");
				if (arg0==3) return Fragment.instantiate(bbsActivity, "com.pkuhelper.bbs.UserinfoFragment");
