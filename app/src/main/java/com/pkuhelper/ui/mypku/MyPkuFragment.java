package com.pkuhelper.ui.mypku;

/**
 * Created by zyxu on 3/15/16.
 */
...
public class MyPkuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            setView(getList(selfs, string), R.id.mypku_self, "");
        } catch (Exception e) {
            e.printStackTrace();
        }
